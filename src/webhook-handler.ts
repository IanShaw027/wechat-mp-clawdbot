...
import { sendTypingStatus, sendCustomMessage, sendImageByUrl, sendImageMessage, sendVoiceMessage, downloadImageToFile } from "./api.js";
...
const AI_DISABLED_HINT_THROTTLE_MS = 2 * 60 * 1000; // 2 分钟
