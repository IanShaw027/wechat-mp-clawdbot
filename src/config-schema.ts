...
const knowledgeProviderSchema = {
  type: "object",
  properties: {
    type: { type: "string", enum: ["local", "dify", "milvus"] },
...
const knowledgeSchema = {
  type: "object",
  properties: {
    mode: { type: "string", enum: ["local", "external", "hybrid"] },
    providers: { type: "array", items: knowledgeProviderSchema },
  },
  additionalProperties: false,
};
...
export const wempConfigSchema: ChannelConfigSchema = {
  schema: {
